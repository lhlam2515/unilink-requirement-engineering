...
| SCR-011 | User_DealNegotiation_Screen | Authenticated User | BP-01 | Bước 3 | Thương thảo hợp đồng tài trợ | UC-14, UC-15, UC-16, UC-17, UC-18, UC-19 | Hub thương thảo: chat + meeting + agreement |
| SCR-012 | User_ContractEdit_Screen | Authenticated User | BP-01 | Bước 4 | Soạn thảo và ký kết hợp đồng | UC-20, UC-21, UC-33 | Soạn thảo + xác nhận + hủy đồng thuận |
| SCR-013 | User_ContractSign_Screen | Authenticated User | BP-01 | Bước 4 | Soạn thảo và ký kết hợp đồng | UC-22 | Ký chữ ký điện tử |
| SCR-014 | User_ContractView_Screen | Authenticated User | BP-01 | Bước 4 | Soạn thảo và ký kết hợp đồng | UC-23, UC-24 | Xem HĐ đã ký + xuất PDF + VAT |
...
| UC-14 | Trao đổi tin nhắn | SCR-010, SCR-011 | Entry via SCR-010 → Chat panel trên SCR-011 |
...
| UC-18 | Xác nhận đồng thuận | SCR-011 | Action: CTA "Xác nhận đồng thuận" |
...
| UC-22 | Ký hợp đồng điện tử | SCR-013 | Screen chính (signature pad) |
| UC-23 | Xuất hợp đồng PDF | SCR-014 | Action: nút "Xuất PDF" |
| UC-24 | Yêu cầu hóa đơn VAT | SCR-014 | Modal: form VAT trên screen xem HĐ |
...
| UC-33 | Hủy đồng thuận ký kết | SCR-012 | Action: CTA + confirm dialog trên screen soạn thảo |
...
| D5 | 6 UC gộp vào SCR-011 (Deal Negotiation) | UC-14~19 | Hub thương thảo — cùng deal context, không có navigation boundary thực sự |
| D6 | UC-33 (Hủy đồng thuận) gộp vào SCR-012 | UC-20, UC-21, UC-33 | Cùng contract context, action button + confirm dialog |
...
| D9 | UC-24 (VAT) là modal trên SCR-014 | UC-24 | Form nhỏ, cùng context HĐ đã ký |
...
- **Screen ID format**: `SCR-XXX` — số tuần tự, có thể mở rộng (SCR-020, SCR-021,...) khi thêm screens cho quy trình mới
