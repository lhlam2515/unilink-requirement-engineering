...
| 5 | System | Hiển thị các trường tóm tắt: tên sự kiện, năm, hình thức tài trợ (CASH/IN_KIND/MIXED), trạng thái hoàn tất, nhãn tóm tắt, và thời điểm hoàn tất |
| 6 | System | Mỗi mục có thể hiển thị liên kết sang view hồ sơ BTC tương ứng (nếu có và đủ điều kiện public) |
| 7 | System | Use case kết thúc thành công |

**Alternate Flows**

> AF-48.a: Không có lịch sử công khai (triggered at Step 2)

| Step | Actor / System | Action |
|------|----------------|--------|
| 2a | System | Phát hiện không có mục lịch sử hợp lệ |
| 2b | System | Hiển thị empty state "Chưa có lịch sử giao dịch công khai" |

> AF-48.b: Có nhiều hơn 5 mục — phân trang (triggered at Step 4)
...
> EF-48.1: Tổ chức không phải Sponsor hoặc chưa VERIFIED (triggered at Step 2)

| Step | Actor / System | Action |
|------|----------------|--------|
| 2a | System | Phát hiện hồ sơ không thuộc vai trò Sponsor hoặc chưa VERIFIED |
...
- Người dùng xem được lịch sử giao dịch tài trợ công khai của tổ chức
...
- BR-1104: Chỉ hiển thị lịch sử public phù hợp với vai trò Sponsor
...
- Mỗi mục có thể liên kết sang view hồ sơ BTC tương ứng (nếu có và đủ điều kiện public)
