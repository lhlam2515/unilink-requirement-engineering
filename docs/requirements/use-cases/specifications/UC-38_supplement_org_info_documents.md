# Use-Case Specification: UC-38 — Bổ sung thông tin và tài liệu minh chứng
...
##### AF-38.a: Tài liệu minh chứng cho Organizer
>
> *Triggered at Step 4 of the Basic Flow when actor là Organizer.*
...
##### AF-38.b: Tài liệu minh chứng cho Sponsor
>
> *Triggered at Step 4 of the Basic Flow when actor là Sponsor.*
...
##### AF-38.c: Bổ sung nhiều tài liệu
>
> *Triggered at Step 5 of the Basic Flow when actor chọn thêm file.*
...
##### AF-38.d: File trùng tên trong cùng loại tài liệu
>
> *Triggered at Step 8 of the Basic Flow when file có cùng tên đã tồn tại.*
...
##### AF-38.e: Đổi tên file khi upload
>
> *Triggered at Step 5 of the Basic Flow when actor muốn đổi tên hiển thị.*
...
##### EF-38.1: File vượt quá kích thước cho phép
>
> *Triggered at Step 7 of the Basic Flow when file > 10MB.*
...
##### EF-38.2: Định dạng file không hợp lệ
>
> *Triggered at Step 6 of the Basic Flow when file có định dạng không được hỗ trợ.*
...
##### EF-38.3: Đã quá hạn 14 ngày bổ sung
>
> *Triggered at Step 3 of the Basic Flow when quá 14 ngày từ ngày tạo tài khoản.*
...
|-------------|------|-------------|
| SC-38-01 | Bổ sung thành công | Actor tải lên tài liệu hợp lệ; hồ sơ sẵn sàng gửi xác thực |
| SC-38-02 | File trùng tên | File đã tồn tại; actor chọn thay thế hoặc hủy (AF-38.d) |
| SC-38-03 | File không hợp lệ | File sai định dạng hoặc quá 10MB; upload bị từ chối (EF-38.1, EF-38.2) |
...
#### 5.2 Đã hoàn tất đăng ký cơ bản

- Actor đã hoàn tất đăng ký cơ bản (UC-34 hoặc UC-35)

#### 5.3 Hồ sơ chưa VERIFIED
...
- UC-34 / UC-35: Đăng ký tài khoản (prerequisite — đăng ký cơ bản trước)
- UC-39: Chỉnh sửa hồ sơ tổ chức (sequential — chỉnh sửa thông tin)
- UC-40: Gửi hồ sơ xác thực (sequential — gửi sau khi bổ sung đầy đủ)
